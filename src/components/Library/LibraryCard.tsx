    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        <div className="absolute top-3 left-3">
          <span
            className={`px-2.5 py-1 rounded-full text-xs font-semibold flex items-center gap-1.5 backdrop-blur-md ${
              isAnime
        ...
        <div className="absolute bottom-3 left-3">
          <span
            className={`px-3 py-1.5 rounded-full text-xs font-semibold border bg-gradient-to-br ${getStatusColor(item.status)}`}
          >
